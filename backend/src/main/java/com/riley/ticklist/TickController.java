...
public class TickController {
    ...
    public Tick getTick(@PathVariable("id") Long id) {
        return tickRepository.findById(id).orElse(null);
    }
    ...
    public Tick updateTick(
        ...
        Tick existingTick = tickRepository.findById(id).orElse(null);
        ...
        existingTick.setUser(updatedTick.getUser());
